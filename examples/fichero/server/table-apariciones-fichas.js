...
var tableApariciones = require('./table-apariciones.js');
var tableFichas = require('./table-fichas.js');

module.exports = function(context){
    // tableMixin(tableApariciones, tableFichas)
    var table1 = tableApariciones;
    var table2 = tableFichas;
    ...
    var tableDef=changing({
        name:'apariciones-fichas',
        title:'apariciones'
    },td1);
    console.log('xxxxxxxxxxxxxxx td');
