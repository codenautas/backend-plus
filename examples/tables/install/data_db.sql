...
('100', 'Fermium', 'Fm', '3', '7', 'f', null, 'Synthetic', 'Actinide'),
('101', 'Mendelevium', 'Md', '3', '7', 'f', null, 'Synthetic', 'Actinide'),
('102', 'Nobelium', 'No', '3', '7', 'f', null, 'Synthetic', 'Actinide'),
('103', 'Lawrencium', 'Lr', '3', '7', 'd', null, 'Synthetic', 'Actinide'),
('104', 'Rutherfordium', 'Rf', '4', '7', 'd', null, 'Synthetic', 'Transition metal'),
('105', 'Dubnium', 'Db', '5', '7', 'd', null, 'Synthetic', 'Transition metal'),
('106', 'Seaborgium', 'Sg', '6', '7', 'd', null, 'Synthetic', 'Transition metal'),
('107', 'Bohrium', 'Bh', '7', '7', 'd', null, 'Synthetic', 'Transition metal'),
('108', 'Hassium', 'Hs', '8', '7', 'd', null, 'Synthetic', 'Transition metal'),
('109', 'Meitnerium', 'Mt', '9', '7', 'd', null, 'Synthetic', null),
('110', 'Darmstadtium', 'Ds', '10', '7', 'd', null, 'Synthetic', null),
('111', 'Roentgenium', 'Rg', '11', '7', 'd', null, 'Synthetic', null),
('112', 'Copernicium', 'Cn', '12', '7', 'd', null, 'Synthetic', 'Transition metal'),
('113', '(Ununtrium)', '(Uut)', '13', '7', 'p', null, 'Synthetic', null),
('114', 'Flerovium', 'Fl', '14', '7', 'p', null, 'Synthetic', 'Post-transition metal'),
('115', '(Ununpentium)', '(Uup)', '15', '7', 'p', null, 'Synthetic', null),
('116', 'Livermorium', 'Lv', '16', '7', 'p', null, 'Synthetic', null),
('117', '(Ununseptium)', '(Uus)', '17', '7', 'p', null, 'Synthetic', null),
('118', '(Ununoctium)', '(Uuo)', '18', '7', 'p', null, 'Synthetic', null);
...
insert into ext.element_images(atomic_number, mass_number, kind, url) values 
  ...
  (2,4,'tube','https://upload.wikimedia.org/wikipedia/commons/c/c3/Helium_spectra.jpg'),
  (2,4,'atom','https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/Blausen_0476_HeliumAtom.png/100px-Blausen_0476_HeliumAtom.png'),
  (3,7,'spectrum','https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Spectrum_Lines_of_Li.png/220px-Spectrum_Lines_of_Li.png'),
  (1,1,'crystal','https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Hexagonal.svg/50px-Hexagonal.svg.png'),
  (2,4,'crystal','https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/Hexagonal_close_packed.svg/50px-Hexagonal_close_packed.svg.png'),
