...
ProcedureTables = [
    ...
    },
    {
        ...
        coreFunction:function(context, parameters){
            var be=context.be;
            console.log('entra',{username:context.username, machineId:context.machineId, navigator: context.navigator}, parameters);
            return {username: context['username'], machineId: context['machineId'],navigator: context['navigator']};
        }
    },
    {
        action:'admin/chpass',
