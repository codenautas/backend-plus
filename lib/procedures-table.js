...
ProcedureTables = [
    ...
    },
    {
        ...
        coreFunction:async function(context, parameters, files, opts){
            ...
            if(defTable.sql.from && result.row && (!opts || !opts.forImport || true)){
    ...
    },
    {
        ...
        coreFunction:async function(context, parameters, files){
            ...
            return Promise.resolve().then(function(){
                ...
                var total=1;
                var origin=new Date();
                if(defTable.sql.constraintsDeferred){
                    await context.client.query("SET CONSTRAINTS ALL DEFERRED");
                }
                return readerFunction.then(function(rowsAndOtherFieldsNames){
                    ...
                    await context.client.query("SET CONSTRAINTS ALL IMMEDIATE");
                    context.informProgress({lengthComputable:true, loaded:readed, total:total});
