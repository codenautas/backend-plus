    ...
    },
    {
        ...
        coreFunction:function(context, parameters, files){
            ...
            return Promise.resolve().then(function(){
                            ...
                            fields.forEach(function(field){
                                ...
                                var value=cell?(
                                    (typeStore.type[field.typeName] && typeStore.type[field.typeName].fromExcelCell)?
                                        typeStore.type[field.typeName].fromExcelCell(cell):cell.v||null
                                    ):null;
                ...
                var numberInsertedRows=0;
                var numberUpdatedRows=0;
                return readerFunction.then(function(rowsForUpsert){
                    ...
                    rowsForUpsert.forEach(function(newRow){
                        ...
                        if(!skip){
                            promiseChain = promiseChain.then(function(){
                                ...
                                console.log("result después de import",result.command)
                            });
                        }else{
                    ...
                    return JSON.stringify({numberInsertedRows,numberUpdatedRows});
                });
            }).catch(function(err){
