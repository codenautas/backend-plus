...
ProcedureTables = [
    {
        ...
        coreFunction:async function(context, parameters){
            ...
            return changing(struct, changes,changing.options({deletingValue:undefined}));
        }
    },
    {
        action:'table_data',
        ...
        */
        async function tableDatum(context, parameters){
            ...
            var sql="SELECT "+[...defTable.sql.select, ...otherColumns].join(', ')+
                ...
                var testCandidateColumnAndAddIt=function testCandidateColumnAndAddIt(fieldName, iColumn, cellAddress){
                    ...
                    if(fieldName && fieldName!='#ignore'){
                        ...
                        if(defField && 
                            ...
                            (defField.inTable || !defField.generatedAs) &&
