...
module.exports = function(context){
    ...
    return context.be.tableDefAdapt({
        ...
        fields:[
            ...
            {name:'num_avg'               , typeName:'decimal'    ,summary:{expr:`avg(case when ${$1_is_num} then $1::text::decimal else null end)`, excludeTypes:['boolean','bigint','integer','decimal']}},
            {name:'numbers'               , typeName:'bigint'     ,summary:{expr:`sum(case when ${$1_is_num} then 1 else null end)`, excludeTypes:['boolean','bigint','integer','decimal']}},
