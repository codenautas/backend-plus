...
function tableDefAdapt(tableDef, context){
    ...
    resultTableDef.JSONFieldForOtherFields = tableDef.fields.find(function findDefaultForOthers(field) { 
    ...
    resultTableDef.sql.tableName = resultTableDef.sql.tableName || resultTableDef.name;
