...
AppBackend.prototype.clientIncludesList = function clientIncludesList(req){
    var list = [
        ...
        // { type: 'js' , module: 'postgres-interval', file: 'index.js' },
...
AppBackend.prototype.clientIncludes = function clientIncludes(req) {
    let list = this.clientIncludesList(req);
    return list.map(inclution => Object.assign({
        ...
        href: inclution.type == 'css' ? ((inclution.path ? inclution.path : 'css') + '/' + (inclution.file ? inclution.file : (inclution.module + '.css'))) : ''
    }, inclution));
}
