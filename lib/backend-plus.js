...
AppBackend.prototype.addLoggedServices = function addLoggedServices(){
    ...
    var optsGenericForAll={
        cacheControl:!be.config.devel || be.config.devel['cache-content'], 
        maxAge:1000*60*60*24*15
    }
    var optsGenericForFiles=changing(optsGenericForAll,{
        allowedExts:be.exts.normal,
        jade:{
            skin:skin, 
            skinUrl:skinUrl,
    ...
    this.app.use('/img',serveContent(Path.join(__dirname,'../for-client/img'), optsGenericForImg));
