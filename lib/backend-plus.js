                        ...
                        if(procedureDef.bitacora.always){
                            ...
                            if(lastBitacoraInsertedId){
                                await be.inTransaction(req,async function(client){
                                    ...
                                    await client.query(updateUpdateSQL(updateElement, 'bitacora', updateConditions)).execute();
                                });
                            }else{
                                await be.inTransaction(req).then(async function(client){
                                    var result = await client.query(generateInsertSQL(defInsertElement)).fetchUniqueRow();
