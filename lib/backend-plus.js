...
AppBackend.prototype.dumpDbSchemaPartial = function dumpDbSchemaPartial(partialTableStructures, complete = true){
    var be = this;
    var db=be.db;
...
AppBackend.prototype.dumpDbSchema = async function dumpDbSchema(){
    var be = this;
    var {mainSql,enancePart} = await be.dumpDbSchemaPartial(be.tableStructures)
