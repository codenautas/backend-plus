...
AppBackend.prototype.i18n.messages.es={
    unlogged:{
        ...
        newPassword:{
            ...
            mailSubject: "Solicitud de cambio de contraseña",
            mailHtml: `<p>Hemos recibido una solicitud para restablecer la contraseña de su cuenta. Si usted realizó esta petición, por favor, haga clic en el siguiente enlace para crear una nueva contraseña:</p>
            <p><a href=""></a></p>
            <p>Si usted no solicitó este cambio, puede ignorar este correo electrónico. Su contraseña actual permanecerá sin modificaciones.</p>`,
                    ...
                    return pg.connect(paramsDb).then(function(client){
                        ...
                        return client.executeSentences([
                            ...
                            if(username){
                                ...
                                return client.query(`CALL set_app_user('!login')`).execute().then(function(){
                                    return client;
                                });
                            }
                        }).then(function(client){
