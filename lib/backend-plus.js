...
AppBackend.prototype.clientModules = function clientModules(){
    return {scripts:[
        ...
        {src:'best-globals.js'                                      },
        {src:'json4all.js'                                          },
        {src:'dialog-promise.js'                                    },
        {src:'js-to-html.js'                                        },
        {src:'pikaday/pikaday.js'                                   },
        {src:'big.js'                                               },
        {src:'type-store.js'                                        },
        {src:'typed-controls.js'                                    },
        {src:'ajax-best-promise.js'                                 },
        {src:'my-things.js'                                         },
        {src:'my-skin.js'                                           },
        {src:'my-tables.js'                                         },
...
AppBackend.prototype.dumpDbTables = function dumpDbTables(){
    ...
    return Promise.all(Object.keys(be.tableStructures).map(function(tableName){
        ...
        return fs.readFile('install/adapt.sql', {encoding:'UTF8'}).catch(function(err){
            if(err.code!='ENOENT'){
                throw err;
            }
            return '';
        });
    }).then(function(textAdapt){
