        ...
        return locatePath(buscarEn).then(function(theTableFileName){
            ...
            if(/[-[]/.test(content[0])){
                if(tablesWithStrictSequence[tableName]){
                    console.log("no se puede preparar un dump para una tabla con secuencia automatica a partir de un YAML");
                    throw new Error("Can't dump from YAML for "+tableName)
                }
