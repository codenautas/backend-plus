...
MiniTools.globalOpts.serveErr.propertiesWhiteList=['detail','code','table','constraint'];
...
AppBackend.prototype.exts = {
    ...
    normal: ['', 'js', 'map', 'html', 'css', 'jpg', 'jpeg', 'png', 'ico', 'gif']
};
                    ...
                    return Promise.resolve().then(function(){
                        ...
                        if(procedureDef.progress!==false){
                            context.informProgress=function informProgress(message){
                                console.log('informProgress',message);
