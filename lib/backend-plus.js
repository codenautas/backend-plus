...
console.log('xxxxxxxxxxxxxxxxx j.t', json4all._types);
...
AppBackend.prototype.addPublicServices = function addLoggedServices(mainApp, baseUrl){
    ...
    mainApp.use(baseUrl, extensionServeStatic('./node_modules/big.js', {staticExtensions:'js'}));
    mainApp.use(baseUrl, extensionServeStatic('./node_modules/type-store', {staticExtensions:'js'}));
}
