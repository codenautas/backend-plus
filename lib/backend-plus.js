    ...
    return html.div([
        ...
        html.h2({style:'text-align:center'},[html.code([
            html.a({
                ...
                href:be.config.server["base-url"]+(be.config.login.plus.loginUrlPath||'/login')
            },'login')
        ])]),
...
AppBackend.prototype.addUnloggedServices = function addUnloggedServices(mainApp, baseUrl){
    var be=this;
    if(be.config.login.unloggedLandPage){
        mainApp.get(baseUrl+be.config.login.unloggedLandPage, function(req, res, next){
            res.status(401);
    ...
    console.log('la cuelgo de ========== ', baseUrl+'img/login-logo-icon.png')
    // http://localhost:3033/img/login-logo-icon.png
    mainApp.get(baseUrl+'/img/login-logo-icon.png', async function(req,res,next){
        console.log('entre a buscar la imagen')
        var buscar = ['unlogged/img/login-logo-icon.png', 'unlogged/img/logo.png', 'client/img/logo.png', 'unlogged/img/logo-128.png' ];
